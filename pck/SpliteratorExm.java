...
{ 
    ...
    { 
        ...
        Spliterator<Integer> alsl = al.spliterator();      
...
System.out.println("stream=="+str);          
        ...
        //functinal interface..consumer .accept(n) ..   
        splitr1.forEachRemaining((n) -> System.out.println("forEach n: "+n)); 
...
// anyone method we can invoke not all.
        while(splitr1.tryAdvance((n)->System.out.println("element: "+n))); 
        //as above method is called for below no eleemnts available
        //splitr1.forEachRemaining((n) -> System.out.println(n));               
        while(splitr1.tryAdvance((n)->System.out.println("element: "+n))); 
    } 
} 